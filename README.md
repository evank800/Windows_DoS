This is a PoC(Proof of Concpet) for the Windows vunerability CVE-2024-38063. The codes for the actual exploitation is written by Photubias from Exploitdb.
